...
Once the `conda-forge` channel has been enabled, `cuda-nvcc, cuda-nvcc-impl_linux-64, cuda-nvcc-split, cuda-nvcc_linux-64, cuda-nvcc_linux-aarch64, cuda-nvcc_linux-ppc64le` can be installed with `conda`:

```
conda install cuda-nvcc cuda-nvcc-impl_linux-64 cuda-nvcc-split cuda-nvcc_linux-64 cuda-nvcc_linux-aarch64 cuda-nvcc_linux-ppc64le
```

or with `mamba`:

```
mamba install cuda-nvcc cuda-nvcc-impl_linux-64 cuda-nvcc-split cuda-nvcc_linux-64 cuda-nvcc_linux-aarch64 cuda-nvcc_linux-ppc64le
```
